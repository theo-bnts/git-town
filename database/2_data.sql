INSERT INTO public."role" (id, created_at, updated_at, name) VALUES
  ('f6c1c99e-39cb-484a-964c-61a719b39662'::uuid, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'student'),
...
INSERT INTO public.ue (id, created_at, updated_at, initialism, name) VALUES
  ('a4f37644-6081-461b-a8d9-219c0e64cf44'::uuid, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'EDC', 'Étude de cas');
