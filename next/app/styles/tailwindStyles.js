...
const inputStyles = {
  default:
    "border-[0.5px] border-[var(--accent-color)] placeholder-[var(--hint-color)] text-[var(--secondary-color)] py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-[var(--accent-color)]",
  disabled:
    "border-[0.5px] border-[var(--hint-color)] bg-[var(--primary-color)] text-[var(--hint-color)] py-2 px-4 rounded cursor-not-allowed",
};

const cardStyles = {
  default: "bg-[var(--primary-color)] text-[var(--secondary-color)] p-6 rounded-[12.5px] drop-shadow-[0_2px_15px_rgba(0,0,0,0.2)]",
};
