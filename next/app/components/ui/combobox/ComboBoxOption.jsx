  ...
  return (
    <div
      ...
      className={`
        ...
        ${isHighlighted ? 'bg-gray-300 opacity-100' : 'hover:bg-gray-200 hover:opacity-100'}
      `}
    ...
    >
      <span
        className={`
          transition-all duration-200 ease-in-out
          ${isSelected ? 'text-[var(--selected-color)]' : ''}
          ${isHighlighted ? 'opacity-100 translate-x-1' : 'opacity-80 group-hover:opacity-100 group-hover:translate-x-1'}
        `}
      >
      ...
      {isSelected ? (
        <IssueClosedIcon className="text-[var(--selected-color)] transition-opacity duration-200 ease-in-out" />
      ) : (
        <IssueOpenedIcon
          className={`
